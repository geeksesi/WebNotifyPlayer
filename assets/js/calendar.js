...
function add_from_calendar(date) 
{
    // console.log(date[0]+" ::: "+date[1]+" ::: "+date[2]+" :: :: :: HELLWO");
    $('input[id=calendar_year]').val(date[0]);
    $('input[id=calendar_month]').val(date[1]);
    $('input[id=calendar_day]').val(date[2]);
}

function calendar_form()
{
    var myForm = document.getElementById('calendar_form');
    var formData = new FormData(myForm);
    formData.append('submit', 'calendar_form');
    $.ajax(
    {
        url: "?submit",
        cache: false,
...
function calendar_checked(checkboxElem) 
{
  if (checkboxElem.checked) 
  {
    $("input[id=calendar_exp]").prop('disabled', false);
  } 
  else 
  {
    $("input[id=calendar_exp]").prop('disabled', true);
  }
}
...
{
    var myForm = document.getElementById('monthly_form');
    var formData = new FormData(myForm);
    formData.append('submit', 'monthly_form');
    $.ajax(
    {
        url: "?submit",
        cache: false,
...
function week_form()
{
    ...
    var formData = new FormData(myForm);
    formData.append('submit', 'week_form');
    $.ajax(
    {
        url: "?submit",
        cache: false,
...
function adhan_form()
{
    var myForm = document.getElementById('adhan_form');
    var formData = new FormData(myForm);
    formData.append('submit', 'adhan_form');
    $.ajax(
    {
        url: "?submit",
        cache: false,
